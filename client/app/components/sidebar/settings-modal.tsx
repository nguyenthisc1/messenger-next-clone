...
import { useUpdateProfileMutation } from '@/app/apis/auth.api'
import { SET_USER } from '@/app/redux/reducer/auth.slice'
...
export default function SettingsModal({ isOpen, onClose, currentUser = {} }: SettingsModalProps) {
    ...
    const onSubmit: SubmitHandler<FieldValues> = (data) => {
        ...
        updateProfileApi({ email: currentUser.email, ...data }).unwrap()
            .then((data) => {
                router.refresh();
                onClose();
